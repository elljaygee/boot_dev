function calculateCampaignMetrics(sent, opened, clicked) {
  ...
  // can only return a single value from a function, so if multiple values are required you need to return an object containing all the values you want to be returned
  return {
    openRate, 
    clickRate, 
    conversionRate,
