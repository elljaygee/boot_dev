...
// the ? operator is an optional chaining operator, means that if the item following it exists then it will be returned otherwise it will be undefined but not throw an error
